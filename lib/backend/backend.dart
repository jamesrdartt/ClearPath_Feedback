...
import 'schema/upvotes_record.dart';
...
export 'schema/upvotes_record.dart';
...
/// Functions to query UpvotesRecords (as a Stream and as a Future).
Future<int> queryUpvotesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UpvotesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UpvotesRecord>> queryUpvotesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UpvotesRecord.collection,
      UpvotesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UpvotesRecord>> queryUpvotesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
